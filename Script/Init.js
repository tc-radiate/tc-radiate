$(document).ready(function () {
    ...
    $(document).ajaxError(function(event, request, settings, error) {
        if (error=="")
            error = "Sorry! I can't access the build service, are you sure '" + teamCityUrl + "' is the right url for your TeamCity server, or maybe you need to configure the proxy so AJAX can request the service?";
